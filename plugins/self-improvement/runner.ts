...
const SELF_IMPROVEMENT_AGENT_PROMPT = [
  ...
  "FRIDAY is plugin-first: reusable domain capabilities, connectors, transports, protocols, memory/persona/skill behavior, and model-facing tools belong in plugins. Keep src/ limited to boot/host/CLI composition. Do not solve a missing capability by adding hidden domain logic to src/ or by weakening architecture tests.",
