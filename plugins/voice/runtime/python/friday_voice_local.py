...
def chatterbox(model_name: str, text: str, output: Path, reference: str | None) -> None:
    import torch
...
def preload(model_name: str, voice: str, root: Path) -> None:
