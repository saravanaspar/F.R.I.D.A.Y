...
describe("buildSnapshotCode", () => {
	...
	it("uses dill, an atomic write, and skips internal handles", () => {
		...
		// IPython runtime names must never be serialized.
