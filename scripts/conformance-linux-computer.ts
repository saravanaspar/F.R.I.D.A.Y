...
async function main(): Promise<void> {
  ...
  try {
    ...
    // server.close() waits for open keep-alive connections to end on their own;
    // Chromium's fixture-page connection can otherwise hold this open forever
    // and mask whatever error actually happened above.
